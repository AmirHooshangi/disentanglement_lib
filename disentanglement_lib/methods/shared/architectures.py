...
def layerwise_conv_encoder(input_tensor, num_latent, is_training=True,
  ...
  model = tf.keras.Sequential([
      tfp.layers.Convolution2DFlipout(
          32, kernel_size=4, padding='SAME', strides=2, activation=None,
      ...
      tfp.layers.Convolution2DFlipout(
          64, kernel_size=2, padding='SAME', strides=2, activation=None,
      kernel_divergence_fn=lambda q, p, ignore: lambdA * tfd.kl_divergence(q, p)),
      tfp.layers.Convolution2DFlipout(
          64, kernel_size=2, padding='SAME', strides=2, activation=None,
      kernel_divergence_fn=lambda q, p, ignore: zeta * tfd.kl_divergence(q, p)),
