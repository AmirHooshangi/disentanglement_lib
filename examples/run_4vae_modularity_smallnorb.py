...
path_vae = os.path.join(base_path, "4vae")
...
train.train_with_gin(os.path.join(path_vae, "model"), overwrite, ["4vae_smallnorb.gin"])
...
gin_bindings = [
    ...
    "modularity_explicitness.num_train=1000",
    "modularity_explicitness.num_test = 1000",
    "discretizer.discretizer_fn = @histogram_discretizer",
    "discretizer.num_bins = 20"
]
for path in [path_vae]:
  result_path = os.path.join(path, "metrics", "modularity_explicitness")
  representation_path = os.path.join(path, "representation")
